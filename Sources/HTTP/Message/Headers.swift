...
/// ```
///
/// [For more information, see the documentation](https://docs.vapor.codes/3.0/http/headers/)
public struct Headers: Codable {
    ...
    ///
    /// [For more information, see the documentation](https://docs.vapor.codes/3.0/http/headers/#accessing-headers)
