...
///
/// [For more information, see the documentation](https://docs.vapor.codes/3.0/http/response/)
...
///
/// [For more information, see the documentation](https://docs.vapor.codes/3.0/http/response/#responseinitializable)
...
///
/// [For more information, see the documentation](https://docs.vapor.codes/3.0/http/response/#responserepresentable)
