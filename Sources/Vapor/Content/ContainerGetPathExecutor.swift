...
extension Decoder {
    ...
    fileprivate func unkeyedContainer(startingAt index: Int) throws -> any UnkeyedDecodingContainer {
        ...
        guard container.currentIndex == index, !container.isAtEnd else {
            throw DecodingError.keyNotFound(
                index.codingKey, .init(codingPath: container.codingPath, debugDescription: "Missing index \(index)"))
        }
        return container
    }
}
