...
//    ///     - HTTPMediaType: `Encoder` will be used to encode this `MediaType`.
//    public mutating func use(encoder: HTTPMessageEncoder & DataEncoder, for HTTPMediaType: HTTPMediaType) {
//        use(httpEncoder: encoder, for: HTTPMediaType)
//        use(dataEncoder: encoder, for: HTTPMediaType)
//    }
//
...
//    ///     - HTTPMediaType: `Decoder` will be used to decode this `MediaType`.
//    public mutating func use(decoder: HTTPMessageDecoder & DataDecoder, for HTTPMediaType: HTTPMediaType) {
//        use(httpDecoder: decoder, for: HTTPMediaType)
//        use(dataDecoder: decoder, for: HTTPMediaType)
//    }
//
...
//    ///     - HTTPMediaType: `Encoder` will be used to encode this `MediaType`.
//    public mutating func use<B>(encoder: B.Type, for HTTPMediaType: HTTPMediaType) where B: HTTPMessageEncoder & DataEncoder {
//        use(httpEncoder: encoder, for: HTTPMediaType)
//        use(dataEncoder: encoder, for: HTTPMediaType)
//    }
//
...
//    ///     - HTTPMediaType: `Decoder` will be used to decode this `MediaType`.
//    public mutating func use<B>(decoder: B.Type, for HTTPMediaType: HTTPMediaType) where B: HTTPMessageDecoder & DataDecoder {
//        use(httpDecoder: decoder, for: HTTPMediaType)
//        use(dataDecoder: decoder, for: HTTPMediaType)
//    }
//
...
//    public mutating func use(httpEncoder: HTTPMessageEncoder, for HTTPMediaType: HTTPMediaType) {
...
//    public mutating func use(httpDecoder: HTTPMessageDecoder, for HTTPMediaType: HTTPMediaType) {
...
//    ///     - HTTPMediaType: `HTTPMessageEncoder` will be used to encode this `MediaType`.
//    public mutating func use<B>(httpEncoder: B.Type, for HTTPMediaType: HTTPMediaType) where B: HTTPMessageEncoder {
//        self.httpEncoders[mediaType] = { container in
...
//    ///     - HTTPMediaType: `HTTPMessageDecoder` will be used to decode this `MediaType`.
//    public mutating func use<B>(httpDecoder: B.Type, for HTTPMediaType: HTTPMediaType) where B: HTTPMessageDecoder {
//        self.httpDecoders[mediaType] = { container in
//            return try container.make(B.self)
//        }
//    }
...
//    ///     - HTTPMediaType: `DataEncoder` will be used to encode this `MediaType`.
//    public mutating func use(dataEncoder: DataEncoder, for HTTPMediaType: HTTPMediaType) {
...
//    ///     - HTTPMediaType: `DataDecoder` will be used to decode this `MediaType`.
//    public mutating func use(dataDecoder: DataDecoder, for HTTPMediaType: HTTPMediaType) {
...
//    ///     - HTTPMediaType: `DataEncoder` will be used to encode this `MediaType`.
//    public mutating func use<D>(dataEncoder: D.Type, for HTTPMediaType: HTTPMediaType) where D: DataEncoder {
//        self.dataEncoders[mediaType] = { container in
...
//    ///     - HTTPMediaType: `DataDecoder` will be used to decode this `MediaType`.
//    public mutating func use<D>(dataDecoder: D.Type, for HTTPMediaType: HTTPMediaType) where D: DataDecoder {
//        self.dataDecoders[mediaType] = { container in
//            return try container.make(D.self)
//        }
//    }
