...
internal final class Branch {
     ...
     */
    private var handler: HTTP.Responder?
     ...
     */
    func handle(request: HTTP.Request, comps: CompatibilityGenerator<String>) -> HTTP.Responder? {
     ...
     */
    func extendBranch(_ generator: CompatibilityGenerator<String>, handler: HTTP.Responder) {
