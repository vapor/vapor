...
//        }
//        var startLine: String { fatalError("override") }
//        var headers: Headers { fatalError("override") }
//        var body: Body { fatalError("override") }
//    }
//}

// Empty for now, will hopefully fill with more metadata
public protocol ProtocolFormat {}

public enum _HTTPMessageBody {
    case data(Bytes)
    case chunked((ChunkStream) throws -> Void)
}
...
//struct HTTPRequest: _HTTPMessage {
//    typealias Test = _HTTPMessage
//    var startLine: String { fatalError() }
//    var headers: Headers { fatalError() }
//    var body: Vapor.Body { fatalError() }
//
//    let method: Method
//    let uri: URI
//    let version: Version
...
extension HTTP {
    typealias Serializer<MessageType: HTTP.Message> = _HTTPMessageSerializer<MessageType>
}

public final class _HTTPMessageSerializer<MessageType: HTTP.Message> {
...
public final class _HTTPMessageParser<MessageType: HTTP.Message> {
