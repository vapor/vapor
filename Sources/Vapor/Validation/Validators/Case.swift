extension Validator {
    ...
    public static func `case`<E>(of enum: E.Type) -> Validator<T>
        where E: RawRepresentable & CaseIterable & VaporSendableMetatype, E.RawValue == T, T: CustomStringConvertible
    {
        .init {
...
extension ValidatorResults {
    ...
    public struct Case<T, E>
        where E: RawRepresentable & CaseIterable & VaporSendableMetatype, E.RawValue == T, T: CustomStringConvertible & Sendable
    {
