...
#warning("TODO: update keyed cache sessions")
...
//
//    /// See `Sessions`.
//    public func updateSession(_ session: Session) throws -> EventLoopFuture<Void> {
...
//
//    /// See `Sessions`.
//    public func destroySession(sessionID: String) throws -> EventLoopFuture<Void> {
