...
//public final class _FrameDeserializer<O: OutputStream where O.Element == Byte> {
...
//            throw "479: WebSockets.Swift: FrameDeserializer"
//        }
...
//}
//
//extension _FrameDeserializer where O: StreamBuffer {
...
//}
//
//extension _FrameDeserializer {
//    public static func parse(data: O) throws -> WebSocketMessage {
//        let parser = _FrameDeserializer(data)
