...
extension Config {
    ...
    internal mutating func addConfigurable<C>(_ item: @escaping Config.Lazy<C>, name: String) throws {
    ...
    internal mutating func addConfigurable<C>(
        instance: C,
        unique: String,
        name: String
    ) {
    ...
    internal mutating func addConfigurable<C: ConfigInitializable>(
        class: C.Type,
        unique: String,
        name: String
    ) {
