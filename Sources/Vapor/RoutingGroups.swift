...
///
/// [For more information, see the documentation](https://docs.vapor.codes/3.0/vapor/route-group/)
...
extension Router {
    ...
    ///
    /// [For more information, see the documentation](https://docs.vapor.codes/3.0/vapor/route-group/#path-components)
    ...
    ///
    /// [For more information, see the documentation](https://docs.vapor.codes/3.0/vapor/route-group/#middleware)
