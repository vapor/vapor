...
extension Router {
    ...
    @discardableResult
    public func get<T>(_ path: PathComponentsRepresentable..., use closure: @escaping (HTTPRequestContext) throws -> T) -> Route<Responder>
    ...
    /// - returns: Discardable `Route` that was just created.
    @discardableResult
    public func post<T>(_ path: PathComponentsRepresentable..., use closure: @escaping (HTTPRequestContext) throws -> T) -> Route<Responder>
        where T: HTTPResponseEncodable
    {
    ...
    /// - returns: Discardable `Route` that was just created.
    @discardableResult
    public func patch<T>(_ path: PathComponentsRepresentable..., use closure: @escaping (HTTPRequestContext) throws -> T) -> Route<Responder>
        where T: HTTPResponseEncodable
    {
    ...
    /// - returns: Discardable `Route` that was just created.
    @discardableResult
    public func put<T>(_ path: PathComponentsRepresentable..., use closure: @escaping (HTTPRequestContext) throws -> T) -> Route<Responder>
        where T: HTTPResponseEncodable
    {
    ...
    /// - returns: Discardable `Route` that was just created.
    @discardableResult
    public func delete<T>(_ path: PathComponentsRepresentable..., use closure: @escaping (HTTPRequestContext) throws -> T) -> Route<Responder>
        where T: HTTPResponseEncodable
    {
    ...
    /// - returns: Discardable `Route` that was just created.
    @discardableResult
    public func on<T>(_ method: HTTPMethod, at path: PathComponentsRepresentable..., use closure: @escaping (HTTPRequestContext) throws -> T) -> Route<Responder>
        where T: HTTPResponseEncodable
    {
    ...
    /// - returns: Discardable `Route` that was just created.
    @discardableResult
    private func _on<T>(_ method: HTTPMethod, at path: [PathComponent], use closure: @escaping (HTTPRequestContext) throws -> T) -> Route<Responder>
        where T: HTTPResponseEncodable
    {
