...
//    public func webSocketShouldUpgrade(for request: HTTPRequestContext) -> HTTPHeaders? {
...
//    public func webSocketOnUpgrade(_ webSocket: WebSocket, for request: HTTPRequestContext) {
...
//    @discardableResult
//    public func get(at path: [PathComponent], use closure: @escaping (WebSocket, HTTPRequestContext) throws -> ()) -> Route<WebSocketResponder> {
...
//    /// - returns: Discardable websocket responder route. Use this route reference to append metadata to the route.
//    @discardableResult
//    public func get(_ path: PathComponent..., use closure: @escaping (WebSocket, HTTPRequestContext) throws -> ()) -> Route<WebSocketResponder> {
...
//    /// - returns: Discardable websocket responder route. Use this route reference to append metadata to the route.
//    @discardableResult
//    public func get(_ path: PathComponentsRepresentable..., use closure: @escaping (WebSocket, HTTPRequestContext) throws -> ()) -> Route<WebSocketResponder> {
