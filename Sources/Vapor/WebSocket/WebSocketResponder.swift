...
//    internal let shouldUpgrade: (HTTPRequestContext) -> HTTPHeaders?
//
...
//    internal let onUpgrade: (WebSocket, HTTPRequestContext) throws -> ()
//
...
//    public init(shouldUpgrade: @escaping (HTTPRequestContext) -> HTTPHeaders?, onUpgrade: @escaping (WebSocket, HTTPRequestContext) throws -> ()) {
