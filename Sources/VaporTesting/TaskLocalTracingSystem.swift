...
public final class TaskLocalTracingSystemWrapper: Tracer {
    ...
    public func inject<Carrier, Inject>(_ context: ServiceContextModule.ServiceContext, into carrier: inout Carrier, using injector: Inject)
    ...
    public func startSpan<Instant>(
        _ operationName: String, context: @autoclosure () -> ServiceContext, ofKind kind: SpanKind, at instant: @autoclosure () -> Instant,
    ...
    public func startAnySpan<Instant>(
        _ operationName: String, context: @autoclosure () -> ServiceContext, ofKind kind: SpanKind, at instant: @autoclosure () -> Instant,
        function: String, file fileID: String, line: UInt
    ) -> InMemorySpan where Instant: TracerInstant {
        tracer.startAnySpan(operationName, context: context(), ofKind: kind, at: instant(), function: function, file: fileID, line: line)
            as! InMemorySpan
    }
