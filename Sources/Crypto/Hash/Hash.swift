...
/// [For more information, see the documentation](https://docs.vapor.codes/3.0/crypto/hash/)
...
extension Hash {
    ...
    ///
    /// [For more information, see the documentation](https://docs.vapor.codes/3.0/crypto/hash/#hashing-blobs-of-data)
    ...
    ///
    /// [For more information, see the documentation](https://docs.vapor.codes/3.0/crypto/hash/#incremental-hashes-manual)
