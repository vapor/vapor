...
public func XCTAssertContains(_ haystack: String?, _ needle: String?, file: StaticString = fullFilePath(), line: UInt = #line) {
...
public func XCTAssertEqualJSON<T>(_ data: String?, _ test: T, file: StaticString = fullFilePath(), line: UInt = #line)
