...
///
/// [For more information, see the documentation](https://docs.vapor.codes/3.0/async/promise-future-introduction/)
public final class Future<T>: FutureType {
    ...
    ///
    /// [For more information, see the documentation](https://docs.vapor.codes/3.0/async/promise-future-introduction/#futures-without-promise)
    ...
    ///
    /// [For more information, see the documentation](https://docs.vapor.codes/3.0/async/advanced-futures/#adding-awaiters-to-all-results)
