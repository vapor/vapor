...
extension FutureType {
    ...
    ///
    /// [Learn More →](https://docs.vapor.codes/3.0/async/futures/#on-future-completion)
    ...
    ///
    /// [Learn More →](https://docs.vapor.codes/3.0/async/futures/#mapping-results)
    ...
    ///
    /// [Learn More →](https://docs.vapor.codes/3.0/async/futures/#synchronous-apis)
