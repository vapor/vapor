...
extension WebSocket {
    ...
    ///
    /// [For more information, see the documentation](https://docs.vapor.codes/3.0/websocket/upgrade/#determining-an-upgrade)
    ...
    ///
    /// [For more information, see the documentation](https://docs.vapor.codes/3.0/websocket/upgrade/#upgrading-the-connection)
