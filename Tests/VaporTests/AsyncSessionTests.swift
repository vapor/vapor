...
final class AsyncSessionTests: XCTestCase {
    func testSessionDestroy() async throws {
        ...
        app.asyncSessions.use { _ in cache }
        let sessions = app.routes.grouped(app.asyncSessions.middleware)
    ...
    func testInvalidCookie() throws {
        ...
        // Configure sessions.
        app.asyncSessions.use(.memory)
        app.middleware.use(app.asyncSessions.middleware)
