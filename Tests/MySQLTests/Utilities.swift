...
extension MySQLConnection {
    ...
    public func createTable(_ table: Table) -> Completable {
    ...
    public func dropTable(named name: String) -> Completable {
    ...
    public func dropTables(named name: String...) -> Completable {
