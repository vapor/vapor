...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/vapor/async-kit.git", from: "1.1.0"),
        ...
        .package(url: "https://github.com/vapor/routing-kit.git", from: "4.1.0"),
        ...
        .package(url: "https://github.com/apple/swift-nio-ssl.git", from: "2.7.3"),
