...
- Combined application paths such as JSON decode/encode over a socket, multipart
  uploads, authenticated/session requests and an active metrics or tracing backend.
...
CI runs every fixture in smoke mode to validate correctness. Performance
comparisons require controlled hardware and consistent toolchains and dependencies.
